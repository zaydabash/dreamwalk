...
class SyntheticDataGenerator:
    ...
    async def generate_training_data(
        ...
        try:
            ...
            targets = [self._generate_target_embedding(sample, embedding_dim) for sample in features]
    ...
    def _generate_target_embedding(self, feature_sample: Dict[str, Any], embedding_dim: int) -> List[float]:
